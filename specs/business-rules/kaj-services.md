...
1. Initial Consultation
   ...
   └── Identify deductions/allowances
   └── Assess tax residency status

2. Document Collection
   └── Employment income (GRA forms, pay slips)
...
5. Filing & Submission
   └── Submit to GRA (electronic/paper)
...
2. Financial Records Collection
   └── Trial balance
   └── General ledger
   └── Bank statements
   └── Fixed asset register
...
3. Financial Statement Preparation
   ...
   └── Account for losses carried forward
...
6. Filing & Payment
   └── Submit to GRA
   └── Arrange tax payment
   └── File related returns (WHT, etc.)
   └── Update tax calendar for next year
```
...
2. Payroll Calculation
   ...
   └── Calculate NIS (employee + employer)
...
4. Payment Processing
   ...
   └── File in payroll records

5. Statutory Reporting
   └── Prepare PAYE return
   └── Prepare NIS return
   └── File monthly returns with GRA
   └── Remit payments to authorities

6. Record Keeping
   └── Update payroll register
   └── Post to general ledger
   └── Maintain employee files
   └── Archive pay records (7 years)
```

### VAT Return Filing

```
1. Transaction Review (Monthly/Quarterly)
   └── Review all sales (output VAT)
   └── Review all purchases (input VAT)
   └── Identify exempt transactions
   └── Verify VAT rates applied

2. VAT Calculation
   └── Total output VAT collected
   └── Total input VAT paid
   └── Calculate net VAT position
   └── Check non-deductible input VAT
   └── Verify reverse charge VAT

3. Return Preparation
   └── Complete VAT return form
   └── Attach supporting schedules
   └── Reconcile to accounting records
   └── Quality check all figures
...
5. Filing & Payment
   └── Submit to GRA (TRIPS system)
   └── Arrange payment if VAT due
   └── Claim refund if in credit position
   └── Retain filing confirmation

6. Record Keeping
   └── File VAT return copy
   └── Update VAT calendar
   └── Track refund status
...
| Service | Price Range (GYD) |
|---------|-------------------|
| Individual Tax Return (Simple) | $15,000 - $30,000 |
| Individual Tax Return (Complex) | $35,000 - $60,000 |
| Corporate Tax Return (Small) | $50,000 - $100,000 |
| Corporate Tax Return (Medium/Large) | $120,000 - $300,000 |
| VAT Return (Monthly) | $15,000 - $25,000 |
| PAYE Filing (Monthly) | $10,000 - $20,000 |
| Property Tax Return | $20,000 - $40,000 |
| Tax Planning Consultation | $25,000 - $50,000/session |
| Tax Compliance Review | $75,000 - $150,000 |
| Tax Representation (GRA) | $50,000 - $150,000/case |

### Accounting Services

| Service | Price Range (GYD) |
|---------|-------------------|
| Bookkeeping (Monthly - Simple) | $30,000 - $50,000/month |
| Bookkeeping (Monthly - Complex) | $60,000 - $120,000/month |
| Financial Statements (Annual) | $80,000 - $200,000 |
| Payroll (per employee/month) | $1,500 - $3,000 |
| Bank Reconciliation | $10,000 - $20,000/month |
| Year-End Closing | $100,000 - $250,000 |
| Management Reports | $25,000 - $50,000 |
| Audit Support (per day) | $40,000 - $60,000 |

### Financial Planning

| Service | Price Range (GYD) |
|---------|-------------------|
| Investment Advisory | $50,000 - $100,000 |
| Retirement Planning | $60,000 - $120,000 |
| Estate Planning | $80,000 - $150,000 |
| Business Valuation | $150,000 - $500,000 |
| Financial Health Check | $75,000 - $150,000 |
| Wealth Management (Annual) | 1% - 2% of assets |

### Business Services

| Service | Price Range (GYD) |
|---------|-------------------|
| TIN Registration | $10,000 - $15,000 |
| NIS Registration | $10,000 - $15,000 |
| VAT Registration | $15,000 - $25,000 |
| Certificate of Compliance | $20,000 - $35,000 |
| Tax Clearance Certificate | $25,000 - $40,000 |
| Business Plan Financials | $100,000 - $250,000 |
| Due Diligence | $150,000 - $400,000 |

### Retainer Packages

| Package | Services Included | Monthly Fee (GYD) |
|---------|-------------------|-------------------|
| Basic Compliance | Bookkeeping + PAYE + NIS | $50,000 - $80,000 |
| Standard | Basic + VAT + Tax Planning | $90,000 - $150,000 |
| Premium | Standard + Financial Statements + Advisory | $180,000 - $300,000 |
| Enterprise | Full-service accounting + CFO advisory | $350,000+ |
...
- Employment income
  - GRA income tax form from employer
  - Pay slips (January to December)
  - NIS contribution record
...
- Prepayments and accruals listing
- Bad debt write-offs
- Loan agreements
- Lease agreements
...
| Agency | Full Name | Services | Contact/Location |
|--------|-----------|----------|------------------|
| GRA | Guyana Revenue Authority | All tax matters, TIN, VAT, PAYE, compliance | Main & Urquhart Streets, Georgetown |
| NIS | National Insurance Scheme | Social security contributions, registration | Brickdam, Georgetown |
| Deeds Registry | Deeds & Commercial Registries Authority | Business registration, company records | 1 Avenue of the Republic |
| Bank of Guyana | Central Bank of Guyana | Banking regulations, financial reporting | 1 Avenue of the Republic |

### GRA Divisions

| Division | Services |
|----------|----------|
| Domestic Tax | Income tax, corporation tax, property tax |
| VAT & Excise | VAT registration, returns, compliance |
| Customs | Import/export duties |
| Large Taxpayer Unit | Major corporations, high-value taxpayers |
| Objections & Appeals | Tax disputes, assessments |
| Debt Management | Tax arrears, payment plans |

## Service Level Agreements

### Response Times

- New client inquiry: Within 4 hours (business hours)
- Email response: Within 24 hours
- Phone calls returned: Same business day
- Urgent tax matters: Within 2 hours
- Document requests: Acknowledge within 24 hours

### Completion Targets

| Service | Target | Maximum | Notes |
|---------|--------|---------|-------|
| Individual Tax Return | 5 days | 10 days | From receipt of all documents |
| Corporate Tax Return | 10 days | 21 days | Depends on complexity |
| VAT Return | 3 days | 5 days | Before statutory deadline |
| PAYE Return | 2 days | 3 days | Due 15th of following month |
| Monthly Bookkeeping | 7 days | 14 days | After month-end |
| Financial Statements | 15 days | 30 days | After year-end close |
| Payroll Processing | 2 days | 3 days | Before pay date |
| TIN Registration | 5 days | 10 days | Plus GRA processing time |

### Statutory Deadlines (GRA)

| Filing | Deadline | Late Filing Penalty |
|--------|----------|---------------------|
| Individual Tax Return | April 30 (for prior year) | $10,000 + $1,000/month |
| Corporate Tax Return | 4 months after year-end | $10,000 + interest on tax due |
| VAT Return (Monthly) | 15th of following month | $5,000/day + interest |
| PAYE Return | 15th of following month | $5,000/day + interest |
| NIS Return | 14th of following month | Penalties per NIS Act |
| Withholding Tax | 15th of following month | Interest + penalties |

### Client Communication Standards

**Regular Updates:**
- Monthly clients: Monthly financial reports by 14th
- Quarterly clients: Quarterly reports within 15 days of quarter-end
- Tax season: Weekly status updates during March-April
- Project-based: Weekly progress reports

**Meetings:**
- Annual tax planning: At least once per year
- Quarterly reviews: For retainer clients
- Ad-hoc consultations: As needed, scheduled within 48 hours
...
**Before Submission:**
- [ ] All income sources included and properly classified
- [ ] Deductions supported by documentation
- [ ] Calculations verified (manual + software)
- [ ] Tax rates applied correctly for tax year
- [ ] Prior year returns reviewed for consistency
- [ ] Loss carry-forwards applied correctly
- [ ] Client information accurate (name, TIN, address)
- [ ] Mathematical accuracy verified
- [ ] All required schedules attached
- [ ] Client signature obtained
- [ ] Copy retained for office file
...
- [ ] Deadline for next year diarized
- [ ] Documents archived properly
- [ ] Client file updated
...
- [ ] Fixed assets updated (additions/disposals/depreciation)
- [ ] Prepayments and accruals recorded
...
**Review Stage:**
- [ ] Mathematical accuracy verified
- [ ] Account classifications appropriate
- [ ] Comparative figures agree to prior year
- [ ] Notes to accounts complete
...
**Final Stage:**
- [ ] Partner/principal review completed
- [ ] Management representation letter obtained
- [ ] Statements properly formatted and bound
- [ ] Cover letter prepared
- [ ] Client meeting scheduled
- [ ] Electronic and hard copies delivered

### Bookkeeping Quality Standards

**Monthly Close Checklist:**
- [ ] All transactions recorded in correct period
- [ ] Bank reconciliations completed (zero unexplained items)
- [ ] Credit card reconciliations completed
- [ ] Petty cash reconciled
- [ ] Sales invoices matched to deposits
- [ ] Purchase invoices matched to payments
- [ ] Payroll posted to general ledger
- [ ] Recurring journal entries posted
- [ ] Suspense/clearing accounts reviewed and cleared
- [ ] Trial balance reviewed for unusual balances
- [ ] Prior month adjustments posted
...
**Before Processing:**
- [ ] All time sheets received and approved
- [ ] Rate changes authorized in writing
- [ ] New employee setup complete (NIS, TIN, bank)
- [ ] Termination dates confirmed
- [ ] Statutory rates current (PAYE, NIS)
- [ ] Deduction authorizations on file

**After Processing:**
- [ ] Gross-to-net calculations verified
- [ ] PAYE calculated correctly
- [ ] NIS within statutory limits
- [ ] Bank account details verified
- [ ] Pay slips generated
- [ ] Payroll register updated
- [ ] GL posting accurate
- [ ] Statutory returns prepared
- [ ] Payments to authorities scheduled
...
4. Client Setup
   ...
   └── Obtain necessary registrations (TIN, NIS, etc.)
   └── Set up client file (physical + digital)
   └── Assign client manager
   └── Enter into practice management system
...
6. Kickoff Meeting
   ...
   └── Set document submission procedures
   └── Review calendar of deadlines
```
...
- History of GRA audits or disputes
- Incomplete records
- Industry-specific risks (cash businesses, construction, etc.)

**Mitigation Strategies:**
- Enhanced documentation requirements
- Senior-level review mandatory
- Conservative tax positions
- Written explanations of significant items
- Regular compliance reviews
- Client education on tax obligations

### Professional Standards

**Independence:**
- Cannot audit own bookkeeping work
- Separate tax and audit functions
- Disclose conflicts of interest
- Decline engagements with independence issues

**Competence:**
- Stay current with tax law changes
- Attend professional development courses
- Subscribe to GRA updates
- Maintain professional certifications

**Confidentiality:**
- Secure client files (physical and digital)
...
- Billing realization rate (target: 85%+)
